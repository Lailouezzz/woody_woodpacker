...
/*   Updated: 2025/12/18 11:07:50 by Antoine Mas      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
uint64_t	_get_eh_entry(void)
{
	return (read64(elf_handle.data, ELF64_OFF__EH_ENTRY));
}

static
uint64_t	_get_eh_phoff(void)
{
	return (read64(elf_handle.data, ELF64_OFF__EH_PHOFF));
}

static
uint16_t	_get_eh_phentsize(void)
{
	return (read16(elf_handle.data, ELF64_OFF__EH_PHENTSIZE));
}

static
uint16_t	_get_eh_phnum(void)
{
	return (read16(elf_handle.data, ELF64_OFF__EH_PHNUM));
}
...
{
	write64(elf_handle.data, ELF64_OFF__EH_ENTRY, entry);
}
...
{
	write64(elf_handle.data, ELF64_OFF__EH_PHOFF, off);
}
...
{
	write16(elf_handle.data, ELF64_OFF__EH_PHENTSIZE, entsize);
}
...
{
	write16(elf_handle.data, ELF64_OFF__EH_PHNUM, num);
}

static
uint64_t	_get_eh_shoff(void)
{
	return (read64(elf_handle.data, ELF64_OFF__EH_SHOFF));
}

static
uint16_t	_get_eh_shentsize(void)
{
	return (read16(elf_handle.data, ELF64_OFF__EH_SHENTSIZE));
}

static
uint16_t	_get_eh_shnum(void)
{
	return (read16(elf_handle.data, ELF64_OFF__EH_SHNUM));
}
...
{
	write64(elf_handle.data, ELF64_OFF__EH_SHOFF, off);
}
...
{
	write16(elf_handle.data, ELF64_OFF__EH_SHENTSIZE, entsize);
}
...
{
	write16(elf_handle.data, ELF64_OFF__EH_SHNUM, num);
}
				...
				)
{
	...
	return (read32(page, ELF64_OFF__PH_TYPE));
}
				...
				)
{
	...
	return (read32(page, ELF64_OFF__PH_FLAGS));
}
				...
				)
{
	...
	return (read64(page, ELF64_OFF__PH_OFFSET));
}
				...
				)
{
	...
	return (read64(page, ELF64_OFF__PH_VADDR));
}
				...
				)
{
	...
	return (read64(page, ELF64_OFF__PH_PADDR));
}
				...
				)
{
	...
	return (read64(page, ELF64_OFF__PH_FILESZ));
}
				...
				)
{
	...
	return (read64(page, ELF64_OFF__PH_MEMSZ));
}
				...
				)
{
	...
	return (read64(page, ELF64_OFF__PH_ALIGN));
}
				...
				)
{
	...
	write32(page, ELF64_OFF__PH_TYPE, type);
}
				...
				)
{
	...
	write32(page, ELF64_OFF__PH_FLAGS, flags);
}
				...
				)
{
	...
	write64(page, ELF64_OFF__PH_OFFSET, offset);
}
				...
				)
{
	...
	write64(page, ELF64_OFF__PH_VADDR, vaddr);
}
				...
				)
{
	...
	write64(page, ELF64_OFF__PH_PADDR, paddr);
}
				...
				)
{
	...
	write64(page, ELF64_OFF__PH_FILESZ, filesz);
}
				...
				)
{
	...
	write64(page, ELF64_OFF__PH_MEMSZ, memsz);
}
				...
				)
{
	...
	write64(page, ELF64_OFF__PH_ALIGN, align);
}
				...
				)
{
	...
	return (read32(page, ELF64_OFF__SH_NAME));
}
				...
				)
{
	...
	return (read32(page, ELF64_OFF__SH_TYPE));
}
				...
				)
{
	...
	return (read64(page, ELF64_OFF__SH_FLAGS));
}
				...
				)
{
	...
	return (read64(page, ELF64_OFF__SH_ADDR));
}
				...
				)
{
	...
	return (read64(page, ELF64_OFF__SH_OFFSET));
}
				...
				)
{
	...
	return (read64(page, ELF64_OFF__SH_SIZE));
}
				...
				)
{
	...
	return (read32(page, ELF64_OFF__SH_LINK));
}
				...
				)
{
	...
	return (read32(page, ELF64_OFF__SH_INFO));
}
				...
				)
{
	...
	return (read64(page, ELF64_OFF__SH_ADDRALIGN));
}
				...
				)
{
	...
	return (read64(page, ELF64_OFF__SH_ENTSIZE));
}
				...
				)
{
	...
	write32(page, ELF64_OFF__SH_NAME, name);
}
				...
				)
{
	...
	write32(page, ELF64_OFF__SH_TYPE, type);
}
				...
				)
{
	...
	write64(page, ELF64_OFF__SH_FLAGS, flags);
}
				...
				)
{
	...
	write64(page, ELF64_OFF__SH_ADDR, addr);
}
				...
				)
{
	...
	write64(page, ELF64_OFF__SH_OFFSET, offset);
}
				...
				)
{
	...
	write64(page, ELF64_OFF__SH_SIZE, size);
}
				...
				)
{
	...
	write32(page, ELF64_OFF__SH_LINK, link);
}
				...
				)
{
	...
	write32(page, ELF64_OFF__SH_INFO, info);
}
				...
				)
{
	...
	write64(page, ELF64_OFF__SH_ADDRALIGN, addralign);
}
				...
				)
{
	...
	write64(page, ELF64_OFF__SH_ENTSIZE, entsize);
}
